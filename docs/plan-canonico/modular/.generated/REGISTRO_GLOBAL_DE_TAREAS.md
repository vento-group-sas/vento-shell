...
| --- | --- | --- |
| Última aprobada | `AUTH-UI-044` — Evitar permisos derivados de nombres de rutas | ✅ APROBADA |
| Tarea actual | `AUTH-UI-045` — Unificar navegación y autorización | ⬜ NO INICIADA |
| Siguiente reservada | `AUTH-UI-046` — Mostrar contexto activo en cada aplicación | ⬜ NO INICIADA |
