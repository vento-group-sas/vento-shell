...
| Tareas aprobadas | **1185** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **411** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **74.25% (1185/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-DOM-018 — Integrar etiquetas LOC, LPN, activos y documentos con BLOQUE E4** |
| Tarea actual | **NEXO-DOM-019 — Separar identidad permanente del contenedor físico e identidad temporal o persistente del LPN** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-DOM-020 — Definir cuándo un contenedor conserva, cambia o cierra su LPN** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 43 de 127 aprobadas; NEXO-DOM-019 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-020::GAP-PKG-018** |
| Carril documental | **ACTIVO — NEXO-DOM-019** |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 43 DE 127 APROBADAS — ACTUAL NEXO-DOM-019** |
...
BLOQUE K — 43 de 127 tareas aprobadas
```
