...
| Tareas aprobadas | **1213** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **383** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **76.00% (1213/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-008 — Proteger despacho** |
| Tarea actual | **NEXO-AUTH-009 — Proteger tránsito** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-010 — Proteger recepción** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 71 de 127 aprobadas; NEXO-AUTH-009 pendiente** |
| Estado de implementación | **STATE_INTEGRITY_RECOVERY_REQUIRED** |
| Acción principal obligatoria | **RECONCILE_IMPLEMENTATION_STATE_INTEGRITY — SHELL-CI-020::GAP-PKG-045** |
| Carril documental | **ACTIVO — NEXO-AUTH-009** |
| Carril físico | **IN_PROGRESS — SHELL-CI-020::GAP-PKG-045 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-001 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-018 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-019** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-008` — Proteger despacho |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 71 DE 127 APROBADAS — ACTUAL NEXO-AUTH-009** |
| Implementación física | **SHELL-CI-020::GAP-PKG-045 — IN_PROGRESS | SHELL-CI-022::GAP-PKG-001 — PENDING_AUTHORIZATION | SHELL-CI-022::GAP-PKG-018 — PENDING_AUTHORIZATION | SHELL-CI-022::GAP-PKG-019 — PENDING_AUTHORIZATION** |
...
BLOQUE K — 71 de 127 tareas aprobadas
```
