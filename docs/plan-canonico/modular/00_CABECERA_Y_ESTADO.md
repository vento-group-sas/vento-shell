...
| Tareas aprobadas | **1235** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **361** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **77.38% (1235/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-030 — Ejecutar pruebas integrales del subdominio** |
| Tarea actual | **NEXO-AUTH-031 — Proteger instalaciones, mantenimiento, limpieza, inspecciones, calibración, acceso físico y obras** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-032 — Separar reporte, solicitud, aprobación, ejecución, verificación, liberación, cierre y reapertura** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 93 de 127 aprobadas; NEXO-AUTH-031 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — NEXO-AUTH-031** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-030` — Ejecutar pruebas integrales del subdominio |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 93 DE 127 APROBADAS — ACTUAL NEXO-AUTH-031** |
...
BLOQUE K — 93 de 127 tareas aprobadas
```
