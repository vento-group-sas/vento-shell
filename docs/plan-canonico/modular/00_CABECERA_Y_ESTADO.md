...
| Tareas aprobadas | **1375** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **221** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **86.15% (1375/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **PULSO-UX-006 — Diseñar inicio para supervisor** |
| Tarea actual | **PULSO-UX-007 — Simplificar creación de venta** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **PULSO-UX-008 — Simplificar cobro y medios de pago** |
| Bloque actual | **BLOQUE N — PULSO** |
| Progreso del bloque | **BLOQUE N: 23 de 38 aprobadas; PULSO-UX-007 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — PULSO-UX-007** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `PULSO-UX-006` — Diseñar inicio para supervisor |
...
| CONTINUIDAD ACTIVA | **BLOQUE N: 23 DE 38 APROBADAS — ACTUAL PULSO-UX-007** |
...
BLOQUE N — 23 de 38 tareas aprobadas
```
