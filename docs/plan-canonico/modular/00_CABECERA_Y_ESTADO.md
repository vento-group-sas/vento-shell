...
| Tareas aprobadas | **1164** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **432** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **72.93% (1164/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **AUTH-SIM-010 — Bloquear acciones críticas durante simulación** |
| Tarea actual | **AUTH-SIM-011 — Definir modo solo lectura** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-SIM-012 — Validar navegación como rol simulado** |
| Bloque actual | **BLOQUES P Y Q — Dispositivos compartidos y simulación estricta** |
| Progreso del bloque | **BLOQUES P Y Q: 26 de 30 aprobadas; AUTH-SIM-011 pendiente** |
| Estado de implementación | **GLOBAL_IMPLEMENTATION_READY** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-SIM-011** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-SIM-010` — Bloquear acciones críticas durante simulación |
...
| CONTINUIDAD ACTIVA | **BLOQUES P Y Q: 26 DE 30 APROBADAS — ACTUAL AUTH-SIM-011** |
...
BLOQUES P Y Q — 26 de 30 tareas aprobadas
```
