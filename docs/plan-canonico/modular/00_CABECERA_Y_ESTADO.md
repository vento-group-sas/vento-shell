...
| Tareas aprobadas | **1288** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **308** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **80.70% (1288/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-AUTH-016 — Ejecutar pruebas integrales** |
| Tarea actual | **FOGO-UX-001 — Inventariar procesos reales de producción** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-UX-002 — Separar cocina, panadería y repostería** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 19 de 65 aprobadas; FOGO-UX-001 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-UX-001** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-AUTH-016` — Ejecutar pruebas integrales |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 19 DE 65 APROBADAS — ACTUAL FOGO-UX-001** |
...
BLOQUES L Y M — 19 de 65 tareas aprobadas
```
