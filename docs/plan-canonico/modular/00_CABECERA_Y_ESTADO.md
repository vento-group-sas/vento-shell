...
| Tareas aprobadas | **1312** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **284** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **82.21% (1312/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **ORIGO-AUTH-009 — Limitar órdenes por sede o centro de costo** |
| Tarea actual | **ORIGO-AUTH-010 — Proteger precios y datos sensibles** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **ORIGO-AUTH-011 — Registrar actor de recepción** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 43 de 65 aprobadas; ORIGO-AUTH-010 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — ORIGO-AUTH-010** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `ORIGO-AUTH-009` — Limitar órdenes por sede o centro de costo |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 43 DE 65 APROBADAS — ACTUAL ORIGO-AUTH-010** |
...
BLOQUES L Y M — 43 de 65 tareas aprobadas
```
