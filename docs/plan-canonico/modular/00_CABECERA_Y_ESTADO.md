...
| Tareas aprobadas | **1290** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **306** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **80.83% (1290/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-UX-002 — Separar cocina, panadería y repostería** |
| Tarea actual | **FOGO-UX-003 — Diseñar inicio por área productiva** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-UX-004 — Mostrar producción pendiente del turno** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 21 de 65 aprobadas; FOGO-UX-003 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-UX-003** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-UX-002` — Separar cocina, panadería y repostería |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 21 DE 65 APROBADAS — ACTUAL FOGO-UX-003** |
...
BLOQUES L Y M — 21 de 65 tareas aprobadas
```
