...
| Tareas aprobadas | **1217** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **379** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **76.25% (1217/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-012 — Proteger conteos** |
| Tarea actual | **NEXO-AUTH-013 — Proteger movimientos** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-014 — Proteger catálogo y configuraciones** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 75 de 127 aprobadas; NEXO-AUTH-013 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — NEXO-AUTH-013** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-012` — Proteger conteos |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 75 DE 127 APROBADAS — ACTUAL NEXO-AUTH-013** |
...
BLOQUE K — 75 de 127 tareas aprobadas
```
