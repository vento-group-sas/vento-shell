...
| Tareas aprobadas | **1144** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **452** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **71.68% (1144/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **AUTH-UI-045 — Unificar navegación y autorización** |
| Tarea actual | **AUTH-UI-046 — Mostrar contexto activo en cada aplicación** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-UI-047 — Mostrar rol simulado claramente** |
| Bloque actual | **BLOQUE I — Protección y estados de interfaz** |
| Progreso del bloque | **BLOQUE I: 6 de 12 aprobadas; AUTH-UI-046 pendiente** |
| Estado de implementación | **GLOBAL_IMPLEMENTATION_READY** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-UI-046** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-UI-045` — Unificar navegación y autorización |
...
| CONTINUIDAD ACTIVA | **BLOQUE I: 6 DE 12 APROBADAS — ACTUAL AUTH-UI-046** |
...
BLOQUE I — 6 de 12 tareas aprobadas
```
