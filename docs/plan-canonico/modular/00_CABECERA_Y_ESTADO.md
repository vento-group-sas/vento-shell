...
| Tareas aprobadas | **1126** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **470** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **70.55% (1126/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-APP-009 — Definir página inicial por tipo de usuario** |
| Tarea actual | **SHELL-APP-010 — Explicar por qué una aplicación está bloqueada** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-APP-011 — Separar aplicaciones laborales de superficies adyacentes sin convertir SHELL en acceso del cliente** |
| Bloque actual | **BLOQUE H2 — SHELL como aplicación** |
| Progreso del bloque | **BLOQUE H2: 9 de 21 aprobadas; SHELL-APP-010 pendiente** |
| Estado de implementación | **GLOBAL_IMPLEMENTATION_READY** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-021::GAP-PKG-001** |
| Carril documental | **ACTIVO — SHELL-APP-010** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-APP-009` — Definir página inicial por tipo de usuario |
...
| CONTINUIDAD ACTIVA | **BLOQUE H2: 9 DE 21 APROBADAS — ACTUAL SHELL-APP-010** |
...
BLOQUE H2 — 9 de 21 tareas aprobadas
```
