...
| Tareas aprobadas | **1281** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **315** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **80.26% (1281/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-AUTH-009 — Proteger inicio de producción** |
| Tarea actual | **FOGO-AUTH-010 — Proteger producción parcial** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-AUTH-011 — Proteger finalización** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 12 de 65 aprobadas; FOGO-AUTH-010 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-AUTH-010** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-AUTH-009` — Proteger inicio de producción |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 12 DE 65 APROBADAS — ACTUAL FOGO-AUTH-010** |
...
BLOQUES L Y M — 12 de 65 tareas aprobadas
```
