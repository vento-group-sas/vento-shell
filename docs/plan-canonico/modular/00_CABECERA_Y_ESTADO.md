...
| Tareas aprobadas | **1321** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **275** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **82.77% (1321/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **PASS-UX-008 — Diseñar perfil del cliente** |
| Tarea actual | **PASS-UX-009 — Diferenciar estado pendiente, usado y cancelado** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **PASS-UX-010 — Definir mensajes de error comprensibles** |
...
| Progreso del bloque | **CARRIL PASS: 8 de 13 aprobadas; PASS-UX-009 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — PASS-UX-009** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `PASS-UX-008` — Diseñar perfil del cliente |
...
| CONTINUIDAD ACTIVA | **CARRIL PASS: 8 DE 13 APROBADAS — ACTUAL PASS-UX-009** |
...
CARRIL PASS — 8 de 13 tareas aprobadas
```
