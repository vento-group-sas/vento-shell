...
| Tareas aprobadas | **1339** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **257** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **83.90% (1339/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **ORIGO-UX-003 — Diseñar inicio para solicitante** |
| Tarea actual | **ORIGO-UX-004 — Diseñar inicio para comprador** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **ORIGO-UX-005 — Diseñar inicio para aprobador** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 52 de 65 aprobadas; ORIGO-UX-004 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — ORIGO-UX-004** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `ORIGO-UX-003` — Diseñar inicio para solicitante |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 52 DE 65 APROBADAS — ACTUAL ORIGO-UX-004** |
...
BLOQUES L Y M — 52 de 65 tareas aprobadas
```
