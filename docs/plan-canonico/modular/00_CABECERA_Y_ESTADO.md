...
| Tareas aprobadas | **1265** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **331** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **79.26% (1265/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **AUTH-UI-056 — Validar prototipo antes de implementar** |
| Tarea actual | **AUTH-UI-057 — Definir criterio de usabilidad por pantalla** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-UI-058 — Probar con usuarios reales** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 123 de 127 aprobadas; AUTH-UI-057 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-UI-057** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-UI-056` — Validar prototipo antes de implementar |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 123 DE 127 APROBADAS — ACTUAL AUTH-UI-057** |
...
BLOQUE K — 123 de 127 tareas aprobadas
```
