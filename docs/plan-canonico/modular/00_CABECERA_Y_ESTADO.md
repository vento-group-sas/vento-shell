...
| Tareas aprobadas | **1156** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **440** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **72.43% (1156/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **AUTH-DEV-012 — Manejar sesión expirada** |
| Tarea actual | **AUTH-DEV-013 — Manejar cambio de trabajador** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-DEV-014 — Probar tablets de NEXO** |
| Bloque actual | **BLOQUES P Y Q — Dispositivos compartidos y simulación estricta** |
| Progreso del bloque | **BLOQUES P Y Q: 18 de 30 aprobadas; AUTH-DEV-013 pendiente** |
| Estado de implementación | **GLOBAL_IMPLEMENTATION_READY** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-DEV-013** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-DEV-012` — Manejar sesión expirada |
| Tarea actual | `AUTH-DEV-013` — Manejar cambio de trabajador — **NO INICIADA** |
| Siguiente tarea | `AUTH-DEV-014` — Probar tablets de NEXO |
...
| CONTINUIDAD ACTIVA | **BLOQUES P Y Q: 18 DE 30 APROBADAS — ACTUAL AUTH-DEV-013** |
...
BLOQUES P Y Q — 18 de 30 tareas aprobadas
```
