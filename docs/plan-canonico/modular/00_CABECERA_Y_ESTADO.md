...
| Tareas aprobadas | **1264** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **332** |
| Tareas rechazadas | **0** |
...
| Progreso del bloque | **BLOQUE K: 122 de 127 aprobadas; AUTH-UI-056 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-UI-056** |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 122 DE 127 APROBADAS — ACTUAL AUTH-UI-056** |
...
BLOQUE K — 122 de 127 tareas aprobadas
```
