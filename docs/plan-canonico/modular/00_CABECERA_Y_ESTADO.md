...
| Tareas aprobadas | **1214** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **382** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **76.07% (1214/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-009 — Proteger tránsito** |
| Tarea actual | **NEXO-AUTH-010 — Proteger recepción** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-011 — Proteger ajustes de inventario** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 72 de 127 aprobadas; NEXO-AUTH-010 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **EJECUTAR_IMPLEMENTACION — SHELL-CI-021::GAP-PKG-045** |
| Carril documental | **ACTIVO — NEXO-AUTH-010** |
| Carril físico | **IN_PROGRESS — SHELL-CI-021::GAP-PKG-045 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-001 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-018 | PENDING_AUTHORIZATION — SHELL-CI-022::GAP-PKG-019** |
| Alcance físico autorizado | **SHELL-CI-021::GAP-PKG-045** |

### Continuidad inmediata

| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-009` — Proteger tránsito |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 72 DE 127 APROBADAS — ACTUAL NEXO-AUTH-010** |
| Implementación física | **SHELL-CI-021::GAP-PKG-045 — IN_PROGRESS | SHELL-CI-022::GAP-PKG-001 — PENDING_AUTHORIZATION | SHELL-CI-022::GAP-PKG-018 — PENDING_AUTHORIZATION | SHELL-CI-022::GAP-PKG-019 — PENDING_AUTHORIZATION** |
...
BLOQUE K — 72 de 127 tareas aprobadas
```
