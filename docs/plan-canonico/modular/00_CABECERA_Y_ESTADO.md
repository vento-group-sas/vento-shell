...
| Tareas aprobadas | **1278** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **318** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **80.08% (1278/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-AUTH-006 — Restringir Cocina** |
| Tarea actual | **FOGO-AUTH-007 — Restringir Insumos** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-AUTH-008 — Definir permisos de supervisor** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 9 de 65 aprobadas; FOGO-AUTH-007 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-AUTH-007** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-AUTH-006` — Restringir Cocina |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 9 DE 65 APROBADAS — ACTUAL FOGO-AUTH-007** |
...
BLOQUES L Y M — 9 de 65 tareas aprobadas
```
