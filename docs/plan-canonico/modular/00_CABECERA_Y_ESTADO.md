...
| Tareas aprobadas | **1336** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **260** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **83.71% (1336/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **ORIGO-AUTH-015 — Ejecutar pruebas integrales** |
| Tarea actual | **ORIGO-UX-001 — Inventariar el proceso completo de abastecimiento** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **ORIGO-UX-002 — Separar solicitud, compra, aprobación y recepción** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 49 de 65 aprobadas; ORIGO-UX-001 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — ORIGO-UX-001** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `ORIGO-AUTH-015` — Ejecutar pruebas integrales |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 49 DE 65 APROBADAS — ACTUAL ORIGO-UX-001** |
...
BLOQUES L Y M — 49 de 65 tareas aprobadas
```
