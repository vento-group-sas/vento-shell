...
| Tareas aprobadas | **1293** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **303** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **81.02% (1293/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-UX-005 — Diseñar inicio de lote** |
| Tarea actual | **FOGO-UX-006 — Diseñar producción parcial** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-UX-007 — Diseñar finalización de lote** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 24 de 65 aprobadas; FOGO-UX-006 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-UX-006** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-UX-005` — Diseñar inicio de lote |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 24 DE 65 APROBADAS — ACTUAL FOGO-UX-006** |
...
BLOQUES L Y M — 24 de 65 tareas aprobadas
```
