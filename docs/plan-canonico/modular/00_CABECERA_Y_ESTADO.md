...
| Tareas aprobadas | **1294** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **302** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **81.08% (1294/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **FOGO-UX-006 — Diseñar producción parcial** |
| Tarea actual | **FOGO-UX-007 — Diseñar finalización de lote** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **FOGO-UX-008 — Mostrar receta resumida para operación** |
| Bloque actual | **BLOQUES L Y M — FOGO y ORIGO** |
| Progreso del bloque | **BLOQUES L Y M: 25 de 65 aprobadas; FOGO-UX-007 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — FOGO-UX-007** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `FOGO-UX-006` — Diseñar producción parcial |
...
| CONTINUIDAD ACTIVA | **BLOQUES L Y M: 25 DE 65 APROBADAS — ACTUAL FOGO-UX-007** |
...
BLOQUES L Y M — 25 de 65 tareas aprobadas
```
