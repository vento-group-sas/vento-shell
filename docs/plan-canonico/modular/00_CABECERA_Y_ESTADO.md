...
| Tareas aprobadas | **1220** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **376** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **76.44% (1220/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-015 — Filtrar por sede y área efectivas** |
| Tarea actual | **NEXO-AUTH-016 — Integrar dispositivo compartido** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-017 — Integrar simulación estricta** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 78 de 127 aprobadas; NEXO-AUTH-016 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — NEXO-AUTH-016** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-015` — Filtrar por sede y área efectivas |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 78 DE 127 APROBADAS — ACTUAL NEXO-AUTH-016** |
...
BLOQUE K — 78 de 127 tareas aprobadas
```
