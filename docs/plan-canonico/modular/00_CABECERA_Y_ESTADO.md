...
| Tareas aprobadas | **1179** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **417** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **73.87% (1179/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-DOM-012 — Definir mantenimiento, reparación y disponibilidad** |
| Tarea actual | **NEXO-DOM-013 — Definir baja, descarte, venta o reemplazo** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-DOM-014 — Definir kits, conjuntos y validación de completitud** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 37 de 127 aprobadas; NEXO-DOM-013 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-020::GAP-PKG-018** |
| Carril documental | **ACTIVO — NEXO-DOM-013** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-DOM-012` — Definir mantenimiento, reparación y disponibilidad |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 37 DE 127 APROBADAS — ACTUAL NEXO-DOM-013** |
...
BLOQUE K — 37 de 127 tareas aprobadas
```
