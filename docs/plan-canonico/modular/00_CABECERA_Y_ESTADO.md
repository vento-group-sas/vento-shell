...
| Tareas aprobadas | **1160** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **436** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **72.68% (1160/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **AUTH-SIM-006 — No mezclar permisos reales y simulados** |
| Tarea actual | **AUTH-SIM-007 — Mostrar aviso persistente** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-SIM-008 — Registrar inicio de simulación** |
| Bloque actual | **BLOQUES P Y Q — Dispositivos compartidos y simulación estricta** |
| Progreso del bloque | **BLOQUES P Y Q: 22 de 30 aprobadas; AUTH-SIM-007 pendiente** |
| Estado de implementación | **GLOBAL_IMPLEMENTATION_READY** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — AUTH-SIM-007** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-SIM-006` — No mezclar permisos reales y simulados |
...
| CONTINUIDAD ACTIVA | **BLOQUES P Y Q: 22 DE 30 APROBADAS — ACTUAL AUTH-SIM-007** |
...
BLOQUES P Y Q — 22 de 30 tareas aprobadas
```
