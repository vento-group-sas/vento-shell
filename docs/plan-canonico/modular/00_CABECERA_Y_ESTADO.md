...
| Tareas aprobadas | **1225** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **371** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **76.75% (1225/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **NEXO-AUTH-020 — Ejecutar pruebas integrales** |
| Tarea actual | **NEXO-AUTH-021 — Auditar permisos actuales de LPN, activos y contenedores** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **NEXO-AUTH-022 — Proteger creación, actualización, cierre, anulación y reetiquetado de LPN** |
| Bloque actual | **BLOQUE K — NEXO** |
| Progreso del bloque | **BLOQUE K: 83 de 127 aprobadas; NEXO-AUTH-021 pendiente** |
| Estado de implementación | **GOVERNED_ACTIVE_SET** |
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-022::GAP-PKG-001** |
| Carril documental | **ACTIVO — NEXO-AUTH-021** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `NEXO-AUTH-020` — Ejecutar pruebas integrales |
...
| CONTINUIDAD ACTIVA | **BLOQUE K: 83 DE 127 APROBADAS — ACTUAL NEXO-AUTH-021** |
...
BLOQUE K — 83 de 127 tareas aprobadas
```
