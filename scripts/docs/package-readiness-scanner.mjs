...
function printCliResult(result, { json = false, packageId = null } = {}) {
  ...
  if (current?.next_action.type === 'AUTHORIZE_PHYSICAL_IMPLEMENTATION') {
    ...
    console.log(`AUTHORIZATION COMMAND: ${current.next_action.command}`);
